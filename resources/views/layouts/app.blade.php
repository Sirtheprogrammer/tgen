    ...
    <div class="flex h-screen bg-gray-50">
        ...
        <aside class="hidden lg:flex lg:w-64 bg-gray-900 text-gray-100 flex-col shadow-lg">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="/sonicpesa-accounts" wire:navigate class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors {{ request()->is('sonicpesa-accounts') || request()->is('sonicpesa-accounts/*') ? 'text-gray-100 bg-indigo-600' : 'text-gray-400 hover:text-gray-100 hover:bg-gray-800' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <aside id="mobileSidebar" class="fixed inset-y-0 left-0 w-64 bg-gray-900 text-gray-100 z-50 transform -translate-x-full transition-transform duration-300 lg:hidden flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="/sonicpesa-accounts" wire:navigate onclick="closeMobileSidebar()" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors {{ request()->is('sonicpesa-accounts') || request()->is('sonicpesa-accounts/*') ? 'text-gray-100 bg-indigo-600 font-medium' : 'text-gray-400 hover:text-gray-100 hover:bg-gray-800' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                    </svg>
                    <span>SonicPesa</span>

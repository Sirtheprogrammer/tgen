...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #eab308, #ca8a04); padding: 36px 40px; text-align: center; }
...
<div class="wrapper">
    <div class="card">
        ...
        <div class="body">
            <div class="alert-box">
                <p>⚠️ If you did not make this change, please log in immediately and review your payment gateway settings from the admin <strong>Dashboard</strong>.</p>
            </div>
